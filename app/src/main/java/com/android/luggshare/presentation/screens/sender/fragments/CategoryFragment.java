...
public class CategoryFragment extends CoreFragment {
    ...
    protected int getLayoutResourceId() {
        return R.layout.fragment_sender_category;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnSendPackage:
                ...
                senderRequestBundle.setItem_1(generalItems);
                senderRequestBundle.setItem_2(fragileItems);
                senderRequestBundle.setItem_3(foodItems);
                senderRequestBundle.setItem_4(documentation);
                senderRequestBundle.setItem_5(electronicItems);
                senderRequestBundle.setItem_6(clothingItems);

                Bundle bundle = new Bundle();
                bundle.putSerializable(BundleKeys.SENDER_REQUEST_BUNDLE, senderRequestBundle);

                replaceChildFragmentWithDelay(new PricingFragment(), true, false, bundle, true);
